...
if("TRUE" STREQUAL "TRUE")
  set(lattice_planner_SOURCE_PREFIX /home/computing/RoboticsM/CMP9767M-master/catkin_ws/src/lattice_planner)
  set(lattice_planner_DEVEL_PREFIX /home/computing/RoboticsM/CMP9767M-master/catkin_ws/devel)
  ...
  set(lattice_planner_INSTALL_PREFIX /home/computing/RoboticsM/CMP9767M-master/catkin_ws/install)
...
if(NOT "/home/computing/RoboticsM/CMP9767M-master/catkin_ws/devel/include;/home/computing/RoboticsM/CMP9767M-master/catkin_ws/src/lattice_planner/include " STREQUAL " ")
  set(lattice_planner_INCLUDE_DIRS "")
  set(_include_dirs "/home/computing/RoboticsM/CMP9767M-master/catkin_ws/devel/include;/home/computing/RoboticsM/CMP9767M-master/catkin_ws/src/lattice_planner/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lattice_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/computing/RoboticsM/CMP9767M-master/catkin_ws/src/lattice_planner/${idir}'.  ${_report}")
    endif()
    _list_append_unique(lattice_planner_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "lattice_planner")
...
set(lattice_planner_EXPORTED_TARGETS "lattice_planner_generate_messages_cpp;lattice_planner_generate_messages_eus;lattice_planner_generate_messages_lisp;lattice_planner_generate_messages_nodejs;lattice_planner_generate_messages_py")
...
set(pkg_cfg_extras "lattice_planner-msg-extras.cmake")
